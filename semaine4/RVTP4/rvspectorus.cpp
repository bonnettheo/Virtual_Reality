...
RVSpecTorus::RVSpecTorus(double smallRadius, double bigRadius): RVTorus(smallRadius, bigRadius)
{
    m_VSFileName = ":/shaders/VS_lit_texture_torus.vsh";
    m_FSFileName = ":/shaders/FS_lit_spec_torus.fsh";
}

void RVSpecTorus::setTorusTex(QString leftImage, QString rightImage, QString frontImage, QString backImage, QString topImage, QString bottomImage)
{
