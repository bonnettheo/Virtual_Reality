...
void RVWidget::initializeGL()
{
    ...
    m_camera2 = new RVSubjectivCamera();
    m_camera2->setZMax(2000);
    m_camera2-> setPosition(QVector3D(10, 50, -100));
    m_camera2->setFov(45);
    ...
    m_batiment = new RVModel("/home/bonnet/Documents/cours-si5/RV/semaine7/final/tuto7/model/IUT_INFO.X");
...
void RVWidget::paintGL()
{
    ...
    if(m_help){
        ...
        p.drawText(5, 5, width(), height(), Qt::AlignLeft, "Commands\n H = help\n up = Move Forward\n down = Move Backward\n left/right = Move Left/Right\n mouse = Move vision left/right/up/down\n space = jump\n c = crouch\n fps =" + QString::number(fps, 'f',2) );
    }
}
