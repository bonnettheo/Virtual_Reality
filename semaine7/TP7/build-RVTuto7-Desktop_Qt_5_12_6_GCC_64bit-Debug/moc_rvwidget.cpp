...
QT_MOC_LITERAL(5, 42, 13), // "changeOpacity"
QT_MOC_LITERAL(6, 56, 15), // "changeWireFrame"
QT_MOC_LITERAL(7, 72, 13), // "changeCulling"
QT_MOC_LITERAL(8, 86, 11), // "changeScale"
QT_MOC_LITERAL(9, 98, 1), // "s"
QT_MOC_LITERAL(10, 100, 16), // "changeSaturation"
QT_MOC_LITERAL(11, 117, 16), // "changeCameraType"
QT_MOC_LITERAL(12, 134, 1) // "b"

    },
    "RVWidget\0update\0\0startAnimation\0"
    "changeFov\0changeOpacity\0changeWireFrame\0"
    "changeCulling\0changeScale\0s\0"
    "changeSaturation\0changeCameraType\0b"
};
...
void RVWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->changeWireFrame((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 5: _t->changeCulling((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 6: _t->changeScale((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 7: _t->changeSaturation((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 8: _t->changeCameraType((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}
